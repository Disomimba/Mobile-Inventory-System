        ...
        children: [
          StreamBuilder<List<CustomerOrder>>(
            ...
            builder: (context, snapshot) {
              ...
              final preparedOrders = snapshot.data!.where((o) => o.status == 'prepared').toList();
              if (preparedOrders.isEmpty) return const SizedBox.shrink();
              ...
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                    const Text('Orders Ready for Pickup:', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.green)),
                    ...preparedOrders.map((o) => ListTile(
                      dense: true,
                      contentPadding: EdgeInsets.zero,
                      title: Text('Order #${o.id.substring(0,8)}'),
                      subtitle: Text('${o.items.length} items ready'),
